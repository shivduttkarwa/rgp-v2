      ...
      <div className="rg-footer__main">
        ...
        <div className="rg-footer__brand">
          <a href="/" className="rg-footer__logo">
            <div className="rg-footer__logo-icon">
              <svg
            ...
            <div className="rg-footer__logo-text">
              <span className="rg-footer__logo-name">Real Gold</span>
              <span className="rg-footer__logo-tagline">Properties</span>
            </div>
          </a>

          <p className="rg-footer__brand-desc">
            Elevating real estate experiences since 2012. Connecting discerning
            buyers with extraordinary properties across the UAE.
          </p>

          <div className="rg-footer__trust">
            <div className="rg-footer__trust-item">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
        ...
        <div className="rg-footer__contact">
          ...
          <a href="tel:+971501234567" className="rg-footer__contact-item">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <a href="mailto:info@realgold.ae" className="rg-footer__contact-item">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
